...
export const CONTRACTS = {
  optionsHook: "0x0000000000000000000000000000000000000088" as `0x${string}`,
  optionSeries: "0x0000000000000000000000000000000000000000" as `0x${string}`,
  collateralVault: "0x0000000000000000000000000000000000000000" as `0x${string}`,
  volOracle: "0x0000000000000000000000000000000000000000" as `0x${string}`,
